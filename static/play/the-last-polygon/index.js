...
// include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmpo1iq7se5.js
...
// end include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmpo1iq7se5.js
// include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmponijs02v.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmponijs02v.js
// include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmpo1i7c6hv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/5m/g__95q5104183wlpv6tkg07w0000gn/T/tmpo1i7c6hv.js
...
var ASM_CONSTS = {
  5384840: () => { if (document.fullscreenElement) return 1; },  
 5384886: () => { return document.getElementById('canvas').width; },  
 5384938: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5385006: () => { document.exitFullscreen(); },  
 5385033: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 5385106: () => { if (document.fullscreenElement) return 1; },  
 5385152: () => { return document.getElementById('canvas').width; },  
 5385204: () => { return screen.width; },  
 5385229: () => { document.exitFullscreen(); },  
 5385256: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 5385389: () => { return window.innerWidth; },  
 5385415: () => { return window.innerHeight; },  
 5385442: () => { if (document.fullscreenElement) return 1; },  
 5385488: () => { return document.getElementById('canvas').width; },  
 5385540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5385608: () => { if (document.fullscreenElement) return 1; },  
 5385654: () => { return document.getElementById('canvas').width; },  
 5385706: () => { return screen.width; },  
 5385731: () => { return window.innerWidth; },  
 5385757: () => { return window.innerHeight; },  
 5385784: () => { if (document.fullscreenElement) return 1; },  
 5385830: () => { return document.getElementById('canvas').width; },  
 5385882: () => { return screen.width; },  
 5385907: () => { document.exitFullscreen(); },  
 5385934: () => { if (document.fullscreenElement) return 1; },  
 5385980: () => { return document.getElementById('canvas').width; },  
 5386032: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5386100: () => { document.exitFullscreen(); },  
 5386127: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 5386185: () => { return screen.width; },  
 5386210: () => { return screen.height; },  
 5386236: () => { return window.screenX; },  
 5386263: () => { return window.screenY; },  
 5386290: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 5386343: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 5386414: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 5386471: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 5386727: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 5386798: () => { if (document.fullscreenElement) return 1; },  
 5386844: () => { return window.innerWidth; },  
 5386870: () => { return window.innerHeight; },  
 5386897: () => { if (document.pointerLockElement) return 1; },  
